...
public class LoptopPage extends Utility {
    private static final Logger log = LogManager.getLogger(LoptopPage.class.getName());
    ...
    @FindBy(xpath = "//span[contains(text(),'Lenovo Display')]")//2021 Newest Dell Business Laptop Latitude 3520, 15
    ...
    @CacheLookup
    @FindBy(css = "#add-to-cart-button")//input[@id='add-to-cart-button']
