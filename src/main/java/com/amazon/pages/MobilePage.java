...
public class MobilePage extends Utility {
    private static final Logger log = LogManager.getLogger(MobilePage.class.getName());
    ...
    @FindBy(xpath = "//span[contains(text(),'Nokia')]")//2021 Newest Dell Business Laptop Latitude 3520, 15
